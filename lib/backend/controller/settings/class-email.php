...
class Email {
	...
	function add_tab( $sections ) {
		...
		$sections[ self::$id ] = esc_html__( 'Email', 'licenses-manager-for-woocommerce' );
	...
	function add_fields( $settings ) {
		...
		return array(
			array(
				'name' => esc_html__( 'Email', 'licenses-manager-for-woocommerce' ),
				'type' => 'title',
			...
			array(
				...
				'desc_tip'      => esc_html__( 'Display licenses in order emails.', 'licenses-manager-for-woocommerce' ),
				'id'            => 'qlwlm_emails_licenses',
				'type'          => 'checkbox',
				'default'       => 'no',
				'checkboxgroup' => 'start',
				'autoload'      => false,
			...
			array(
				...
				'desc_tip'    => esc_html__( 'Add custom title for the licenses in the emails.', 'licenses-manager-for-woocommerce' ),
				'id'          => 'qlwlm_emails_licenses_title',
				'type'        => 'text',
				'class'       => 'qlwlm-premium-field',
